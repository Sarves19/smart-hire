...
class Booking(BaseModel):
    ...
    def provider_id(self) -> int:
        """
        Bookings don't store provider_id directly - the provider
        is reached through the booked service. Exposed as a
        property so it can still be read like a normal column
        (e.g. by Pydantic's from_attributes and by ownership
        checks in BookingService).
        """
